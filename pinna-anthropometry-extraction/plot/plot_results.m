function [] = plot_results(cfg, pinna_imgs, anthropometry, landmarks, info, right_pinna)
...
%                  [# pinnae]
    ...
    for n = 1:n_pinna_imgs
        ...
        for m = 1:n_metrics_in_fig
            ...
            draw_line(fig, x, y, cfg.plot.arrow_col, 'doublearrow', ...
            ...
            text(mean(x), mean(y), ['$' m_name(1) '_{' m_name(2:end) '}$'], 'Interpreter','latex', 'FontSize',11, 'Color',cfg.plot.label_col);
